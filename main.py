...
r = requests.get("https://scp-wiki.wikidot.com/")
print(r.headers)
class SCP:
    ...
    def __str__(self):
        return f"SCP-{self.number}: {self.name}\nContainment Class: {self.containment_class}\nDisruption Class: {self.disruption_class}\nRisk Class: {self.risk_class}\nImage: {self.image}"
